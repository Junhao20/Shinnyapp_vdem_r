...
**Overview:** Now that you have a clear sense of where you are going with your app, it is time to build it. This is the hard part and you will likely have to invest significant time in wrangling your data and debugging the app. Be patient! It will turn out great and you will have a nice project to show for it. 
...
Before I'm going to move on to the shiny app, I will select the data here first.
...
proj_data <- vdem |>
  ...
  select(
    ...
    equal_protection = v2xeg_eqprotec,
    equal_access = v2xeg_eqaccess,
    equal_distribution = v2xeg_eqdr,
    civil = v2x_cspart
  )
...
# write .csv
write_csv(proj_data, "proj_data.csv")
